...
public class Canvas extends javax.swing.JPanel implements Cloneable
{
     ...
     * Forma seleccionada
     */
    protected graphics.Shape selectedShape;
    /**
     * El clip (borde)
     */
    ...
    private void formMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMousePressed
        ...
        { 
            ...
            try
            {
                ...
                {
                    case POINT:
                        this.selectedShape = new graphics.Point(Config.GENERALCONFIG.clone(), evt.getPoint());
                        break;
                    case LINE:
                        this.selectedShape = new graphics.Line(Config.GENERALCONFIG.clone(), evt.getPoint());
                        break;
                    case RECTANGLE:
                        this.selectedShape = new graphics.Rectangle(Config.GENERALCONFIG.clone(), evt.getPoint());
                        break;
                    case ROUNDRECTANGLE:
                        this.selectedShape = new graphics.RoundRectangle(Config.GENERALCONFIG.clone(), evt.getPoint());
                        break;
                    case ELLIPSE:
                        this.selectedShape = new graphics.Ellipse(Config.GENERALCONFIG.clone(), evt.getPoint());
                        break;
                    case ARC:
                        this.selectedShape = new graphics.Arc(Config.GENERALCONFIG.clone(), evt.getPoint());
                        break;
                    case POLYLINE:
                    {
                        if (this.selectedShape != null && this.selectedShape instanceof Polyline && ((Polyline) this.selectedShape).creating)
                            ...
                            this.selectedShape = new graphics.Polyline(Config.GENERALCONFIG.clone(), evt.getPoint());
                    ...
                    case POLYGON:
                    {
                        if (this.selectedShape != null && this.selectedShape instanceof Polygon && ((Polygon) this.selectedShape).creating)
                            ...
                            this.selectedShape = new graphics.Polygon(Config.GENERALCONFIG.clone(), evt.getPoint());
    ...
    private void paintShapeVector(Graphics g)
    {
        ...
        for (graphics.Shape s : this.shapes)
        {
            s.draw(g2d);
    ...
    private graphics.Shape getSelectedShape(Point2D p)
    {
        for (graphics.Shape s : this.shapes)
            if (s.contains(p))
                return s;
